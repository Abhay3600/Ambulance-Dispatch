...
/*
 ...
 - DFS explores all paths and updates minimum distances
...
void dfsUtil(int u, vector<bool> &visited, vector<int> &dist)
{
    visited[u] = true;
...
// DFS-based shortest path (same interface)
vector<int> dfsShortestPath(int n, int source)
{
...
int main()
{
    ...
    while (Q--)
    {
        ...
        vector<int> dist = dfsShortestPath(n, incident);
